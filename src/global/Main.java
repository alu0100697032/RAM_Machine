...
public class Main {
	...
	public static void main(String[] args) {
		...
		ReadInputFile readInputFile = new ReadInputFile("src/files/inputFile.txt"); // development version
		...
		ReadProgramFile readProgramFile = new ReadProgramFile("src/tests/test2.ram");
